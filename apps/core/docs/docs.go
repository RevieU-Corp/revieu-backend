...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/conversations": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Cursor (conversation id) for the next page",
                        "name": "cursor",
                        "in": "query"
                    },
                    {
        ...
        "/conversations/{id}/messages": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Cursor (message id) for older messages",
                        "name": "cursor",
                        "in": "query"
                    },
                    {
        ...
        "/merchant/vouchers/redeem-by-code": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "Redeem by code request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_domain_voucher_handler.RedeemByCodeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/notifications": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Cursor (notification id) for the next page",
                        "name": "cursor",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "internal_domain_voucher_handler.RedeemByCodeRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
